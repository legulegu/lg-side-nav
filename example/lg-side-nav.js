        ...
        <Nav className="customized-nav-container">
          ...
          <NavGroup title="波段分析">
            <NavItem path="/stockdata/market-analysis-shanghai">
              <Link href="/stockdata/market-analysis-shanghai" target="_blank">上证指数波段分析</Link>
            </NavItem>
            <NavItem path="/stockdata/market-analysis-chuangye">
              <Link href="/stockdata/market-analysis-chuangye" target="_blank">创业板波段分析</Link>
            </NavItem>
            <NavItem path="/stockdata/market-analysis-average-price">
              <Link href="/stockdata/market-analysis-average-price" target="_blank">A股平均股价</Link>
            </NavItem>
          </NavGroup>
          <NavGroup title="行情分析">
            <NavItem path="/stockdata/market-activity">
              <Link href="/stockdata/market-activity" target="_blank">赚钱效应分析</Link>
            </NavItem>
          </NavGroup>
          <NavGroup title="A股市盈率">
            <NavItem path="/stockdata/market_pe">
              <Link href="/stockdata/market_pe" target="_blank">A股整体市盈率</Link>
            </NavItem>
            <NavItem path="/stockdata/shanghaiPE">
              <Link href="/stockdata/shanghaiPE" target="_blank">上证A股市盈率</Link>
            </NavItem>
            <NavItem path="/stockdata/shenzhenPE">
              <Link href="/stockdata/shenzhenPE" target="_blank">深圳A股市盈率</Link>
            </NavItem>
            <NavItem path="/stockdata/zxbPE">
              <Link href="/stockdata/zxbPE" target="_blank">中小板市盈率</Link>
            </NavItem>
            <NavItem path="/stockdata/cybPE">
              <Link href="/stockdata/cybPE" target="_blank">创业板市盈率</Link>
            </NavItem>
          </NavGroup>
          <NavGroup title="港股市盈率">
            <NavItem path="/stockdata/market/hsi">
              <Link href="/stockdata/market/hsi" target="_blank">恒生指数市盈率</Link>
            </NavItem>
          </NavGroup>
          <NavGroup title="美股市盈率">
            <NavItem path="/stockdata/market/nasdaq">
              <Link href="/stockdata/market/nasdaq" target="_blank">纳斯达克市盈率</Link>
            </NavItem>
            <NavItem path="/stockdata/market/dow">
              <Link href="/stockdata/market/dow" target="_blank">道琼斯市盈率</Link>
            </NavItem>
            <NavItem path="/stockdata/market/sandp">
              <Link href="/stockdata/market/sandp" target="_blank">普标500市盈率</Link>
            </NavItem>
          </NavGroup>
          ...
          <NavGroup title="宏观数据">
            <NavItem path="/stockdata/pmi">
              <Link href="/stockdata/pmi" target="_blank">PMI走势</Link>
            </NavItem>
            <NavItem path="/stockdata/m1m2">
              <Link href="/stockdata/m1m2" target="_blank">M1M2走势图</Link>
            </NavItem>
            <NavItem path="/stockdata/broadmoney">
              <Link href="/stockdata/broadmoney" target="_blank">M1-M2剪刀差</Link>
            </NavItem>
          </NavGroup>
          <NavGroup title="情绪指标">
